...
import (
	...
	"github.com/xonas1101/logger-controller/internal/controller"
...
func init() {
	...
	utilruntime.Must(loggerv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "5a5b2bb6.logger.com",
	...
	if err := (&controller.LoggerReconciler{
